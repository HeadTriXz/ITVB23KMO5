...
const icons: Record<string, SolarBoldDuotoneIconFunction> = {
    ...
    "dialog": (color = "black") => (
        <>
            ...
            <Path
                fill={color}
                d="M17.984 14.508a6.43 6.43 0 0 0 .32-.142c.291-.14.622-.189.934-.105l.996.267a1.056 1.056 0 0 0 1.294-1.294l-.267-.996a1.358 1.358 0 0 1 .105-.935A6.5 6.5 0 1 0 9.492 6.016a8 8 0 0 1 8.493 8.492Z"
                opacity={0.6}
            />
        </>
    ),
    ...
    "moon": (color = "black") => (
        <>
            ...
            <Path
                fill={color}
                d="M2 12c0 4.359 2.789 8.066 6.679 9.435A8.973 8.973 0 0 1 8 18c0-2.221.805-4.255 2.138-5.824A6.47 6.47 0 0 1 9 8.5a6.496 6.496 0 0 1 3.143-5.567C12.54 2.693 12.463 2 12 2 6.477 2 2 6.477 2 12Z"
            />
        </>
    ),
    ...
    "sun": (color = "black") => (
        <>
            <Path fill={color} d="M18 12a6 6 0 1 1-12 0 6 6 0 0 1 12 0Z" />
            <Path
                fill={color}
                fillRule="evenodd"
